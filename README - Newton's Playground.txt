...
customizable, letting the user set their personal preference for aspects such as downward gravitational acceleration, ground friction, and ball weight.
...
variables (gravity, friction, a singular object's mass, etc.), our program aims to allow users to
have the power to do so at their fingertips.
